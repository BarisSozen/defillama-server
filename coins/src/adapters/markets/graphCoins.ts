...
const items = [
  ...
  { chain: 'ethereum', endpoint: uniV3('5zvR82QoaXYFyDEKLZ9t6v9adgnptxYpKpSbxtgVENFV'), minTVL: 1e3, minVolume: 1e3, projectName: 'uniswap-v3-ethereum' },
  { chain: 'base',     endpoint: uniV3('43Hwfi3dJSoGpyas9VwNoDAv55yjgGrPpNSmbQZArzMG'), minTVL: 1e3, minVolume: 1e3, projectName: 'uniswap-v3-base' },
  { chain: 'arbitrum', endpoint: uniV3('CJYGNhb7RvnhfBDjqpRnD3oxgyhibzc7fkAMa38YV3oS'), minTVL: 1e3, minVolume: 1e3, projectName: 'uniswap-v3-arbitrum' },
  { chain: 'polygon',  endpoint: uniV3('3hCPRGf4z88VC5rsBKU5AA9FBBq5nF3jbKJG7VZCbhjm'), minTVL: 1e3, minVolume: 1e3, projectName: 'uniswap-v3-polygon' },
  { chain: 'optimism', endpoint: uniV3('Cghf4LfVqPiFw6fp6Y5X5Ubc8UpmUhSfJL82zwiBFLaj'), minTVL: 1e3, minVolume: 1e3, projectName: 'uniswap-v3-optimism' },
  { chain: 'celo',     endpoint: uniV3('ESdrTJ3twMwWVoQ1hUE2u7PugEHX3QkenudD6aXCkDQ4'), minTVL: 1e3, minVolume: 1e3, projectName: 'uniswap-v3-celo' },
  // PancakeSwap V3 — dominant V3 venue on BSC, also strong on arbitrum. Same Uni V3 subgraph schema.
  { chain: 'bsc',      endpoint: uniV3('Hv1GncLY5docZoGtXjo4kwbTvxm3MAhVZqBZE4sUT9eZ'), minTVL: 1e3, minVolume: 1e3, projectName: 'pancakeswap-v3-bsc' },
  { chain: 'arbitrum', endpoint: uniV3('251MHFNN1rwjErXD2efWMpNS73SANZN8Ua192zw6iXve'), minTVL: 1e3, minVolume: 1e3, projectName: 'pancakeswap-v3-arbitrum' },
]
